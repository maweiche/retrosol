...
export default async function handler(
  ...
  res: NextApiResponse<Data | Error>,
    ...
    const mint_to_address = new PublicKey("HZxkqBTnXtAYoFTg2puo9KyiNN42E8Sd2Kh1jq3vT29u")
    ...
    try {
        ...
        const destinationTokenAccount = createAssociatedTokenAccountInstruction(
            public_key, // Payer to create Token Account
            associatedTokenAccount, // Token Account owner
            // public_key, //Owner of the newly created token account
            mint_to_address,
        ...
        const mintToInstruction = createMintToInstruction(
            ...
            200, // Amount (100 for 2 decimal place mint = 1.00 tokens)
